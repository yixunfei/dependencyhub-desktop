...
export const AI_MANAGER_DEFINITIONS: readonly DependencyManagerDefinition[] = [
  ...
  {
    id: 'a2a',
    name: 'A2A Agent Endpoints',
    shortName: 'A2A',
    language: 'JSON agent cards',
    ecosystem: 'Agent-to-Agent Protocol',
    packageManager: 'A2A',
    category: 'ai',
    tools: ['a2a'],
    manifestFiles: ['a2a.json'],
    lockFiles: ['a2a-lock.json'],
    configFiles: ['.well-known/agent-card.json', 'a2a.config.json'],
    detectionFiles: ['a2a.json', 'a2a-lock.json', '.well-known/agent-card.json', 'a2a.config.json'],
    capabilities: ['install', 'uninstall', 'health', 'audit', 'dependency-tree', 'lockfile'],
    scopes: ['project', 'repository'],
    scenarios: ['agent-to-agent federation', 'remote agent discovery', 'agent card governance', 'endpoint transport review'],
    productionTools: ['agent card inventory', 'endpoint transport review', 'endpoint pin evidence'],
    route: '/ai',
    builtIn: false,
    implemented: false,
    status: 'preview',
